...
st.set_page_config(page_title="AI Deployment Project", page_icon=":100:", layout="wide")
...
if st.sidebar.button("Suporte"):
    st.sidebar.write("No caso de dúvidas envie e-mail para: support@aiproject.com")

# Título centralizado
st.title("AI Deployment Project")
st.title("Industrial Maintenance Prediction")
